 ...
 * @author Fernando
 */
public class frmNFCe_ExportarXmlParametros extends javax.swing.JDialog {

    /**
     * Creates new form frmNFCe_RelatorioParametros
     */
    public frmNFCe_ExportarXmlParametros(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("EXPORTAS XML DAS NFC-E EMITIDAS");
        ...
        btExibir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/dinnamus/ui/img/Download.png"))); // NOI18N
        btExibir.setText(" Exportar");
        ...
        PainelBusca.add(btExibir, gridBagConstraints);

        dtDataInicial.setBackground(new java.awt.Color(0, 0, 0));
        ...
        dtDataFinal.setBackground(new java.awt.Color(51, 51, 51));
    ...
    private boolean IniciarUI(){
        ...
        try {
            /*
               Integer nCodigoUsuario = ValidarAcessoAoProcesso.Verificar(null, UsuarioSistema.getIdUsuarioLogado(), "PDV_EXPNFCE", Sistema.getLojaAtual(), true, "Exportar NFC-e");
            if (nCodigoUsuario == 0) {
...
private boolean ExportarXML(){
        ...
        try {                   
            ...
            if (!DataHora.IsDateValid("dd/MM/yyyy", dtDataFinal.getDate())) {
           ...
           new NFCE_Xml().Exportar(tsDataInicial, tsDataFinal, "",opServidor.isSelected());
           //(new Relatorios()).Gerar("Relatório de NFC-e Emitidas",  "/dinnamus/ui/InteracaoUsuario/nfce/relatorio/nfce_emitidas.jasper", parametros, Dao_Jdbc.getConexao().getCNX());
